...
myStartupHook = do
  ...
  spawn "/home/calin/.config/xrandrfix.sh"
  spawn "/home/calin/.xmonad/rrxmobar.sh"
...
myManageHook = composeAll
     ...
     , className =? "qjackctl"     --> doShift ( myWorkspaces !! 9 )
...
myKeys =
    ...
    -- Workspaces
        ...
        , ("M-S-p", spawn "/home/calin/Scripts/rraudio.sh")
...
main = do
    ...
    xmproc0 <- spawnPipe "xmobar /home/calin/.config/xmobar/xmobarrc"
