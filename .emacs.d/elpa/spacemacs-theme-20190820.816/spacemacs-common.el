...
(defun create-spacemacs-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ...
        (bg1           (if (eq variant 'dark) (if (true-color-p) "#282a36" "#262626") (if (true-color-p) "#fbf8ef" "#ffffff")))
        ...
        (comment-bg    (if (eq variant 'dark) (if (true-color-p) "#282b46" "#262626") (if (true-color-p) "#ecf3ec" "#ffffff")))
